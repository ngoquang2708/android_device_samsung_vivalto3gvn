 ...
 * @hide
 */
public class Vivalto3gvnStrategies extends TelephonyStrategies {

    private static final String LOG_TAG = Vivalto3gvnStrategies.class.getSimpleName();

    public Vivalto3gvnStrategies() { }
